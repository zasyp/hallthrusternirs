...
let
    params = PartCount.SimParams(
        L=4, M=100,
        mi=1.0, me=6.55e-6,                     # отношение масс для ксенона
        T_ion=14, v_a=1, n_a_left=60.0, kI=1, kR=0.1,
        γ=1.666667e+00, ε=1.0, ν_m0=15.0,
        α=5.883248e-04, α0=3.065928e+02, ζ=2.114019e-01, ε_dim=1.0,
